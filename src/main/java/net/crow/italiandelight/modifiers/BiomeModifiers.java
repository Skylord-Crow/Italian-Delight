package net.crow.italiandelight.modifiers;
...
import net.crow.italiandelight.init.BiomeInit;


import java.util.Optional;

public record BiomeModifiers(
...
) implements BiomeModifier
{
    ...
    public Codec<? extends BiomeModifier> codec() {
        return BiomeInit.ADD_FEATURES_BY_FILTER.get();
    }
}